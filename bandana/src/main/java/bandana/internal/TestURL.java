...
public class TestURL {
                         ...
                         "SignatureMethod" : "HmacSHA256"*/
                                               ...
                                               /* public TestURL() {
                                                ...
                                                public static String constructRequest(String AWS_ACCESS_KEY_ID,String AWS_SECRET_KEY_ID) throws Exception{
                                                                ...
                                                                parametrMap.put("SignatureMethod",SimpleDBConstant.SignatureMethod);
                                                                parametrMap.put("SignatureVersion",SimpleDBConstant.SignatureVersion);
                                                                
                                                                parametrMap.put("Version",SimpleDBConstant.Version);
     ...
     /*           public static void main(String[] args) throws Exception {
                              ...
                              // URL= TestURL.constructRequest("IAZUS3KLGE2G5G3RH6","D3qiFUYuJLLeOqVu6aoOp1kgo4EE/YvQX9KqmrW2");
                               System.out.println(URL);
                               String[] signedstuff = URL.split("=");
                               String reqdstuff = signedstuff[signedstuff.length-1];
                               System.out.println("This is wat i want---->"+signedstuff[signedstuff.length-1]);
